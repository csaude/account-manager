...
public class ConfigUtils {
    public static final String RUNTIME_PROPS_FILENAME = "account_runtime.properties";
    public static final String RUNTIME_ENV_NAME = "ACCOUNT_RUNTIME_PROPERTIES_PATH";
